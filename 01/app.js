...
function getTotalPrice(productList) {
    ...
    return productList.reduce( (acc, product) => {
        ...
        // console.log(typeof productDiscount);
        return acc + (product.price * product.count * (1 - productDiscount))
    }, 0);
}
const totalPrice = getTotalPrice( getProductList() );
console.log("Cena całkowita:", totalPrice.toFixed(2)); // prawidłowa wartość: 390.42 (należy zaaokrąglić do 2 miejsc po przecinku)